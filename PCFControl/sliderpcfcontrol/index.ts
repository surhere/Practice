...
export class sliderpcfcontrol implements ComponentFramework.StandardControl<IInputs, IOutputs> {
    ...
    public init(context: ComponentFramework.Context<IInputs>, notifyOutputChanged: () => void, state: ComponentFramework.Dictionary, container:HTMLDivElement): void
    {
        ...
        // CRM attributes bound to the control properties. 
         // @ts-ignore 
        var optionsetAttribute: string = context.parameters.new_annual_sales_amount.attributes.LogicalName;
        //@ts-ignore
        ...
        this._range.setAttribute("max","100000004")
        ...
        this._value=context.parameters.new_annual_sales_amount.raw?context.parameters.new_annual_sales_amount.raw:0;
        this._range.value = (context.parameters.new_annual_sales_amount.raw?context.parameters.new_annual_sales_amount.raw:0).toString();
    ...
    public updateView(context: ComponentFramework.Context<IInputs>): void
    {
        ...
        // CRM attributes bound to the control properties. 
        // @ts-ignore 
        var crmTagStringsAttribute = context.parameters.new_annual_sales_amount.attributes.LogicalName;
        ...
        console.log("---Range--",this._range.value)
    ...
    public getOutputs(): IOutputs
    {
        ...
        console.log("---Range--",this._range.value)
        console.log("---Value--",this._value)
        return {new_annual_sales_amount:parseInt(this._range.value)};
    }
